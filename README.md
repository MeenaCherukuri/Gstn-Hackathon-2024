...
<br>Please find the detailed solution in the python files [file1](https://github.com/MeenaCherukuri/Gstn_Hackathon/blob/main/gstn%20hackathon-final.pdf "About all algorithms") and [file2](https://github.com/MeenaCherukuri/Gstn_Hackathon/blob/main/Random_Forest.pdf "About Random Forest metrics").  Also, there is a python notebook [Google Colab](https://colab.research.google.com/drive/1Dj2ZciIako1es8NtCRhEg2wrr6J_goL8?usp=sharing "Drive") which contains preliminary work done by My Team.<br>
# Get Started
